...
// Importar todas las rutas del API
...
app.use('/api/dentalrecords', dentalRecordsRoutes);  // Rutas de registros dentales
app.use('/api/patients', patientRoutes);            // Rutas de pacientes
